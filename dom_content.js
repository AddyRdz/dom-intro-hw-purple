...
function printItems(sectionTag,content){
    const target = document.querySelector(sectionTag)
}
// 6. Print the HTML content of the section tag
function printItems(sectionStrng,content){
    const target = document.querySelector(sectionStrng)